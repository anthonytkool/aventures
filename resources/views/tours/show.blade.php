        ...
        <div class="card-body">
          ...
          <ul class="qi-list">
            <li class="qi-item"><i class="bi bi-clock-history"></i>
              <span><strong>Duration:</strong> {{ $quick['duration'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-geo-alt"></i>
              <span><strong>Start / End:</strong> {{ $quick['start_end'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-alarm"></i>
              <span><strong>Start time:</strong> {{ $quick['start_time'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-truck"></i>
              <span><strong>Pickup:</strong> {{ $quick['pickup'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-people"></i>
              <span><strong>Group size:</strong> {{ $quick['group'] ?? $quick['group_size'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-translate"></i>
              <span><strong>Language:</strong> {{ $quick['language'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-check2-circle"></i>
              <span><strong>Dress:</strong> {{ $quick['dress'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-activity"></i>
              <span><strong>Activity:</strong> {{ $quick['activity'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-emoji-smile"></i>
              <span><strong>Children:</strong> {{ $quick['child'] ?? $quick['children'] ?? '-' }}</span></li>

            <li class="qi-item"><i class="bi bi-shield-check"></i>
              <span><strong>Cancellation:</strong> {{ $quick['cancel'] ?? '-' }}</span></li>
          </ul>
